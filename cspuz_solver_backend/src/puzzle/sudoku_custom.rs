...
use cspuz_rs_puzzles::puzzles::sudoku_custom;

pub fn solve(url: &str) -> Result<Board, &'static str> {
    let problem = sudoku_custom::deserialize_problem(url).ok_or("invalid url")?;
    let ans = sudoku_custom::solve_sudoku_custom(&problem);

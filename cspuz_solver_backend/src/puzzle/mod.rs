...
puzzle_list!(puzz_link,
    ...
    (lightup_custom, ["lightup"], "Lightup Custom", "美術館カスタム"),
    ...
    (country_custom, ["country"], "Country Road Custom", "カントリーロードカスタム"),
    ...
    (gradientwalls, ["gradientwalls"], "Gradient Walls", "グラデーションウォールズ"),
    ...
    (heyawake_custom, ["heyawake"], "Heyawake Custom", "へやわけカスタム"),
    (heyawake2, ["heyawake2"], "Heyawake 2", "へやわけ2"),
    (hitori_custom, ["hitori", "hitori_custom"], "Hitori Custom", "ひとりカスタム"),
    ...
    (kageboshi, ["kageboshi"], "Kageboshi", "カゲボシ"),
    ...
    (minesweeper_custom, ["mines"], "Minesweeper Custom", "マインスイーパカスタム"),
    ...
    (noribridge_custom, ["noribridge"], "Nori Bridge Custom", "のりブリッジカスタム"),
    ...
    (nurikabe_custom, ["nurikabe", "nurikabe_custom"], "Nurikabe Custom", "ぬりかべカスタム"),
    ...
    (sudoku_custom, ["sudoku"], "Sudoku Custom", "数独カスタム"),
    (sudoku2, ["sudoku2"], "Sudoku 2", "数独2"),
    (sukoro, ["sukoro"], "Sukoro", "数コロ"),
    (tapa_custom, ["tapa", "tapa_custom"], "Tapa Custom", "Tapaカスタム"),
    ...
    (tidepool, ["tidepool"], "Tidepool", "タイドプール"),
    ...
    (yajilin_custom, ["yajilin", "yajirin"], "Yajilin Custom", "ヤジリンカスタム"),

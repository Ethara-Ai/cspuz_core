...
use cspuz_rs_puzzles::puzzles::tapa_custom;

pub fn solve(url: &str) -> Result<Board, &'static str> {
    let problem = tapa_custom::deserialize_problem(url).ok_or("invalid url")?;
    let ans = tapa_custom::solve_tapa_custom(&problem);

...
use cspuz_rs_puzzles::puzzles::minesweeper_custom;

pub fn solve(url: &str) -> Result<Board, &'static str> {
    let problem = minesweeper_custom::deserialize_problem(url).ok_or("invalid url")?;
    let ans = minesweeper_custom::solve_minesweeper_custom(&problem);
